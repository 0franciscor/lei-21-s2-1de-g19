...
|:-------------  |:--------------------- |:------------|:---------------------------- |
| Step 1: register a client  		 |... register a client ?							 |Receptionist             |Creator: in the DM receptionist registers clients                              |
...
| Step 4: shows the data and requests a confirmation  		 |... validating the data locally (e.g.: mandatory vs.non-mandatory data)?							 |Receptionist             |IE: knows all the required data                             |
|								 |… validating the data globally (e.g.: duplicated)?										 |Company	       |IE: knows all the client objects         		      |
| Step 5: confirms the data  		 |... saving the registered client?							 |Company             |IE: records all the client objects                              |
