...
| Step 3: types requested data 		 |... saving the input data?							 |ClientStore            |IE: The object created in step 1 has its own data                              |
| Step 4: shows the data and requests a confirmation  		 |... validating the data locally (e.g.: mandatory vs.non-mandatory data)?							 |ClientStore            |IE: knows all the required data                             |
