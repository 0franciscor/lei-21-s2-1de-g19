...
|								 |… validating the data globally (e.g.: duplicated)?										 |Receptionist	       |IE: knows all the client objects         		      |
| Step 5: confirms the data  		 |... saving the registered client?							 |Receptionist             |IE: records all the client objects                              |
