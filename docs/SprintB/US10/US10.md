...
| Step 4: shows the existing parameter categories 		 | ... show 				 |             |                              |
| Step 5: selects one parameter category 		 | ... select 					 |             |                              |
| Step 6: shows the data and requests a confirmation 		 |	... validating the data locally (e.g.:mandatory vs. non-mandatory	data)?						 |             |                              |              
|		 | ... validating the data globally	(e.g.: duplicated)?				 |             |                              |
| Step 7: confirms the data 		 | ... saving the created parameter?						 |             |                              | 
| Step 8: informs operation sucess 		 | ... informing operation success?						 |             |                              | 
### Systematization ##
