...
**Test 1:** Tests if the registration process of the Clinical Analysis Laboratory is working without problems. 
...
**Test 2:** Tests that is impossible to create a ClinicalAnalysisLaboratory object with no ID.
...
**Test 3:** Tests the functionality of registering a Clinical Analysis Laboratory by the ClinicalAnalysisLaboratoryStore.
