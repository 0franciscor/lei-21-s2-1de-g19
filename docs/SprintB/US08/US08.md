...
| Step 8: Shows selected test types and asks for confirmation |	... confirm the operation? | ClinicalAnalysisLaboratoryStore  | IE: is able to confirm the newly registered clinical analysis laboratory |              
| Step 9: Confirms | ... ??? | ??? | ??? |              
