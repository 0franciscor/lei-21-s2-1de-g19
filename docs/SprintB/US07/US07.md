...
**Class Company**
    ...
    public class Company {
        ...
        public boolean createEmployee(empDto) { }
        public Role getRoleById(roleId) { }
        public boolean saveEmployee(emp) { }
    }
...
**Class RolesMapper**
    ...
    public class RegisterNewEmployeeController {
        ...
        public List<RoleDto> toDto(List<Role> lRoles) { }
    }
**Class EmployeeDto**
